...
public class ConnectionController {
    ...
    @RequestMapping(method = RequestMethod.POST,
            consumes = "application/json", produces = "application/json")
    public ResponseEntity<List<Connection>> saveConnection(@RequestBody List<Connection> connection) {
        return new ResponseEntity<>(connectionService.saveConnection(connection), HttpStatus.CREATED);
    }
